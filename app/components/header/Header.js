...
export const Header = () => {
  ...
  <div className="centering main-header__centering">
    ...
    <nav className="main-navigation main-navigation-js">
      ...
      <div className="still-centering still-js">
    ...
    <div className="account-and-etc">
      <div className="personal-account">
        <span className="personal-account__photo"></span>
      ...
      <ul className="list-etc">
        ...
        <li className="list-etc__elem"><a className="list-etc__link search" href="#">
            <svg className="svg-search" viewBox="0 0 4 4">
      ...
      <div className="languages">
        <span className="languages__ru">RU</span>
        <ul className="languages-list languages-list-js">
